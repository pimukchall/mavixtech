  ...
  return (
    <div>
      <div className="flex items-center justify-between mb-8">
        <div>
          <h1 className="text-2xl font-bold mb-1">ข้อความติดต่อ</h1>
          <p className="text-muted-foreground text-sm">
            {contacts.length} ข้อความทั้งหมด
            {unread > 0 && (
              <span className="ml-2 text-primary font-semibold">({unread} ยังไม่อ่าน)</span>
            )}
          </p>
        </div>
      </div>
              ...
              <div className="flex items-start justify-between gap-4">
                <div className="flex-1 min-w-0">
                  <div className="flex items-center gap-2 mb-1 flex-wrap">
                    ...
                    {!c.read && (
                      <Badge className="bg-primary text-primary-foreground text-xs">ใหม่</Badge>
                    )}
